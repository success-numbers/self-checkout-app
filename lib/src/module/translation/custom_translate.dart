class MultiLocalization {
  late Map<String, Translations> translations;

  MultiLocalization();

  static MultiLocalization? _instance;
  static MultiLocalization get instance =>
      _instance ?? (_instance = MultiLocalization());

  String translate(String key, {String? locale}) {
    final translations = this.translations[locale ?? 'en'];
  ...
  static bool load(Map<String, Translations>? translations) {
